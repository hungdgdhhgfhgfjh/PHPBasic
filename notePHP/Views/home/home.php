                    ...
                    <table class="table table-striped text-center table-bordered">
                        ...
                        <?php // foreach ($param['items'] as $key => $item) :   ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?controller=note&action=show&id=<?php // $item->id ?>"><i class="far fa-eye fa-lg text-primary"></i></a>
                                    <a href="index.php?controller=note&action=edit&id=<?php  //$item->id ?>"><i class="fas fa-edit fa-lg text-warning"></i></a>
                                    <span data-bs-toggle="modal" data-bs-target="#delete<?php //$item->id ?>"><i class="fas fa-trash-alt fa-lg text-danger"></i></span>
                                    <!-- The Modal -->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-center">
                                                    <a class="btn btn-danger mr-auto" href="index.php?controller=note&action=delete&id=<?php // $item->id ?>">Xóa</a>
                ...
                <div>
                    <nav aria-label="Page navigation example ">
                        <ul class="pagination d-flex justify-content-end">
                            <li class="page-item"><a class="page-link" href="index.php?controller=note&action=list&page=<?php  //$param['pre'] ?>">Previous</a></li>
                            <?php // for ($i = 1; $i <= $param['total_page']; $i++) : ?>
                                <li class="page-item"><a class="page-link" href="index.php?controller=note&action=list&page=<?php  //$i ?>"><?php //$i ?></a></li>
                            <?php //,kkhv endfor; ?>
                            <li class="page-item"><a class="page-link" href="index.php?controller=note&action=list&page=<?php //$param['next'] ?>">Next</a></li>
                        </ul>
                    </nav>
                </div>
            </div>

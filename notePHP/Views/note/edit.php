<div class="container-fluid">
    ...
    <div class="row mt-2 justify-content-center">
        <div class="col-md-6">
            <form method="POST" action="index.php?note=update&&id=<?php echo $note->id; ?>">
                            ...
                            <?php  endforeach; ?>
                              ...
                              <?php else: ?>
                                <select name="category_id" class="form-select">
                                    <option value="<?php echo $note->category_id ?>"><?= $note->name_categories?></option>
                            <?php foreach ($categories as $key => $category) :
                            ?>
                ...
                <div class="row form-group mt-2">
                    ...
                    <div class="col-md-10">
                        <input value="<?= $note->name_note; ?>" type="text" class="form-control"  name="name_note">
                ...
                <div class="row form-group mt-2">
                    ...
                    <div class="col-md-10">
                        <textarea  type="text" class="form-control <?= (isset($_SESSION['errors']['content'])) ? 'is-invalid' : ''; ?>" name="note_Content" rows="6"><?= $note->note_Content; ?></textarea>
